...
import { BuildingIcon, ChevronDownIcon, ChevronRightIcon, PanelRightCloseIcon } from "lucide-react";
...
export function OrgTreeSidebar({ onClose }: Props) {
