...
const ADMIN_NAV: AppNavItem[] = [
  ...
  { href: "/admin/employees", label: "Nhân sự", description: "Tạo nhân viên kèm tài khoản đăng nhập User hoặc Manager.", module: "wave2" },
  { href: "/admin/users", label: "Tài khoản", description: "Tạo tài khoản đăng nhập Admin, Manager hoặc User.", module: "wave2" },
  { href: "/admin/schedule", label: "Lịch ca", description: "Phân ca theo phòng ban và tuần, sau đó công bố cho nhân viên.", module: "wave3" },
  { href: "/admin/roster", label: "Lịch tổng", description: "Xem phân ca cross-schedule theo tuần và phòng ban.", module: "scheduling" },
...
const MANAGER_NAV: AppNavItem[] = [
  ...
  { href: "/manager/roster", label: "Lịch tổng", description: "Xem phân ca cross-schedule theo tuần và phòng ban.", module: "scheduling" },
