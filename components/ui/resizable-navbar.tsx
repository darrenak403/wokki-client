...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl grid-cols-[auto_1fr_auto] items-center self-start rounded-full bg-transparent px-4 py-2 lg:grid lg:min-w-[900px] dark:bg-transparent",
  ...
  return (
    ...
    >
      {items.map((item, idx) => {
        const isActive =
          activeHref &&
          (item.link === "/" ? activeHref === "/" : activeHref.startsWith(item.link));
        ...
        return (
          <a
            ...
            className={cn(
              "cursor-pointer relative px-4 py-2",
              isActive
